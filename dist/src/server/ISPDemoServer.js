    ...
    function ISPDemoServer(port, databaseUrl) {
        ...
        this.start = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.migrate.rollback()]; // If you don't want reset between restarts, remove this.
                    case 1:
                        _a.sent(); // If you don't want reset between restarts, remove this.
                        return [4 /*yield*/, this.db.migrate.latest()];
                    case 2:
                        _a.sent();
                        ...
                        this.server.on('error', function (msg) {
                            console.error(msg);
                        });
                        return [2 /*return*/];
                }
